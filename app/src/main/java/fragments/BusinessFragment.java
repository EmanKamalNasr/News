        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() &&
                    ...
                    final RecyclerView businessRecyclerView = (RecyclerView) view.findViewById(R.id.home_recyclerview);
                    businessRecyclerView.setLayoutManager(new LinearLayoutManager(BusinessFragment.this.getActivity()));
                    businessRecyclerView.setAdapter(newsAdapter);
                } else {
