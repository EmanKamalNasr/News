        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() &&
                    ...
                    final RecyclerView technologyRecyclerView = (RecyclerView) view.findViewById(R.id.home_recyclerview);
                    technologyRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
                    technologyRecyclerView.setAdapter(newsAdapter);
